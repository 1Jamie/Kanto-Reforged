...
function BattleCompat.isGen2(battle)
  ...
  local Host = package.loaded["mods.Kanto-Reforged.host"]
  if Host and Host.isGen2 and Host.isGen2() then return true end
  return false
end
...
function BattleCompat.applyStatus(battle, battler, status, source, opts)
  ...
  local Abilities = package.loaded["mods.Kanto-Reforged.abilities"]
      or require("mods.Kanto-Reforged.abilities")
