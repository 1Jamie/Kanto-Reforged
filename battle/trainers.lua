...
local MIX = {
  ...
  -- Hideout Giovanni (Game Corner B4F): Steelix + Trapinch foreshadow gym Donphan/Flygon
  { "OPP_GIOVANNI", 1, 1, "STEELIX" },
  { "OPP_GIOVANNI", 1, "add", "TRAPINCH", 25 },
  -- Silph Giovanni: Donphan + Vibrava (mid Flygon line) before Nidoqueen
  { "OPP_GIOVANNI", 2, 3, "DONPHAN" },
  { "OPP_GIOVANNI", 2, "add", "VIBRAVA", 38 },
  ...
  -- Rocket Hideout (Game Corner basement): dark / poison / ground Gen 2–3
  -- B1F parties 8–12
  { "OPP_ROCKET", 8, 1, "SPOINK" },
  { "OPP_ROCKET", 8, 2, "MAKUHITA" },
  { "OPP_ROCKET", 9, 1, "ZIGZAGOON" },
  { "OPP_ROCKET", 9, 2, "MIGHTYENA" },
  { "OPP_ROCKET", 10, 1, "GULPIN" },
  { "OPP_ROCKET", 10, 2, "KOFFING" },
  { "OPP_ROCKET", 10, 3, "GULPIN" },
  { "OPP_ROCKET", 11, 1, "POOCHYENA" },
  { "OPP_ROCKET", 11, 2, "RATICATE" },
  { "OPP_ROCKET", 11, 3, "ZIGZAGOON" },
  { "OPP_ROCKET", 11, 4, "MURKROW" },
  { "OPP_ROCKET", 12, 1, "GULPIN" },
  { "OPP_ROCKET", 12, 2, "KOFFING" },
  -- B2F party 13
  { "OPP_ROCKET", 13, 1, "ZUBAT" },
  { "OPP_ROCKET", 13, 2, "KOFFING" },
  { "OPP_ROCKET", 13, 3, "GULPIN" },
  { "OPP_ROCKET", 13, 4, "ZUBAT" },
  { "OPP_ROCKET", 13, 5, "MIGHTYENA" },
  -- B3F parties 14–15
  { "OPP_ROCKET", 14, 1, "POOCHYENA" },
  { "OPP_ROCKET", 14, 2, "RATICATE" },
  { "OPP_ROCKET", 14, 3, "SPOINK" },
  { "OPP_ROCKET", 15, 1, "MAKUHITA" },
  { "OPP_ROCKET", 15, 2, "MEDITITE" },
  -- B4F parties 16–18 (pre-Giovanni)
  { "OPP_ROCKET", 16, 1, "PHANPY" },
  { "OPP_ROCKET", 16, 2, "EKANS" },
  { "OPP_ROCKET", 16, 3, "SANDSLASH" },
  { "OPP_ROCKET", 17, 1, "SEVIPER" },
  { "OPP_ROCKET", 17, 2, "SANDSHREW" },
  { "OPP_ROCKET", 17, 3, "ARBOK" },
  { "OPP_ROCKET", 18, 1, "KOFFING" },
  { "OPP_ROCKET", 18, 2, "SABLEYE" },
  ...
  -- Rock Tunnel double-Onix Hiker; Cycling Road Biker
  { "OPP_HIKER", 13, 1, "ONIX" },
  { "OPP_HIKER", 13, 2, "ARON" },
  ...
  -- Silph Co: Rockets + Scientists (dark / poison / electric Gen 2–3)
  { "OPP_ROCKET", 23, 1, "CUBONE" },
  { "OPP_ROCKET", 23, 2, "MURKROW" },
  { "OPP_ROCKET", 24, 1, "CROBAT" },
  { "OPP_ROCKET", 24, 2, "ZUBAT" },
  { "OPP_ROCKET", 24, 3, "ZUBAT" },
  { "OPP_ROCKET", 24, 4, "MIGHTYENA" },
  { "OPP_ROCKET", 24, 5, "ZUBAT" },
  { "OPP_ROCKET", 25, 1, "RATICATE" },
  { "OPP_ROCKET", 25, 2, "SPOINK" },
  { "OPP_ROCKET", 25, 3, "MIGHTYENA" },
  { "OPP_ROCKET", 26, 1, "MAKUHITA" },
  { "OPP_ROCKET", 26, 2, "SPOINK" },
  { "OPP_ROCKET", 27, 1, "SEVIPER" },
  { "OPP_ROCKET", 27, 2, "ZUBAT" },
  { "OPP_ROCKET", 27, 3, "CUBONE" },
  { "OPP_ROCKET", 28, 1, "SEVIPER" },
  { "OPP_ROCKET", 29, 1, "SPOINK" },
  { "OPP_ROCKET", 30, 1, "MAKUHITA" },
  { "OPP_ROCKET", 30, 2, "HARIYAMA" },
  { "OPP_ROCKET", 31, 1, "ZUBAT" },
  { "OPP_ROCKET", 31, 2, "MURKROW" },
  { "OPP_ROCKET", 31, 3, "CROBAT" },
  { "OPP_ROCKET", 32, 1, "MIGHTYENA" },
  { "OPP_ROCKET", 32, 2, "SEVIPER" },
  { "OPP_ROCKET", 32, 3, "KOFFING" },
  { "OPP_ROCKET", 32, 4, "CROBAT" },
  { "OPP_ROCKET", 33, 1, "CUBONE" },
  { "OPP_ROCKET", 33, 2, "SABLEYE" },
  { "OPP_ROCKET", 34, 1, "PHANPY" },
  { "OPP_ROCKET", 34, 2, "SANDSLASH" },
  { "OPP_ROCKET", 35, 1, "ZIGZAGOON" },
  { "OPP_ROCKET", 35, 2, "ZUBAT" },
  { "OPP_ROCKET", 35, 3, "CROBAT" },
  { "OPP_ROCKET", 35, 4, "POOCHYENA" },
  { "OPP_ROCKET", 36, 1, "WEEZING" },
  { "OPP_ROCKET", 36, 2, "CROBAT" },
  { "OPP_ROCKET", 36, 3, "GULPIN" },
  { "OPP_ROCKET", 37, 1, "SPOINK" },
  { "OPP_ROCKET", 37, 2, "GULPIN" },
  { "OPP_ROCKET", 37, 3, "MAKUHITA" },
  { "OPP_ROCKET", 38, 1, "CROBAT" },
  { "OPP_ROCKET", 38, 2, "SPOINK" },
  { "OPP_ROCKET", 38, 3, "HYPNO" },
  { "OPP_ROCKET", 39, 1, "HARIYAMA" },
  { "OPP_ROCKET", 40, 1, "POOCHYENA" },
  { "OPP_ROCKET", 40, 2, "ZIGZAGOON" },
  { "OPP_ROCKET", 40, 3, "ZUBAT" },
  { "OPP_ROCKET", 40, 4, "RATTATA" },
  { "OPP_ROCKET", 40, 5, "SEVIPER" },
  { "OPP_ROCKET", 41, 1, "CUBONE" },
  { "OPP_ROCKET", 41, 2, "SABLEYE" },
  { "OPP_ROCKET", 41, 3, "MAROWAK" },

  { "OPP_SCIENTIST", 2, 1, "GULPIN" },
  { "OPP_SCIENTIST", 2, 2, "WEEZING" },
  { "OPP_SCIENTIST", 2, 3, "KOFFING" },
  { "OPP_SCIENTIST", 2, 4, "SWALOT" },
  { "OPP_SCIENTIST", 3, 1, "ELECTRIKE" },
  { "OPP_SCIENTIST", 3, 2, "VOLTORB" },
  { "OPP_SCIENTIST", 3, 3, "MAGNETON" },
  { "OPP_SCIENTIST", 4, 1, "ELECTRIKE" },
  { "OPP_SCIENTIST", 4, 2, "WEEZING" },
  { "OPP_SCIENTIST", 5, 1, "MANECTRIC" },
  { "OPP_SCIENTIST", 6, 1, "MAGNETON" },
  { "OPP_SCIENTIST", 6, 2, "GULPIN" },
  { "OPP_SCIENTIST", 6, 3, "WEEZING" },
  { "OPP_SCIENTIST", 6, 4, "ELECTRIKE" },
  { "OPP_SCIENTIST", 7, 1, "VOLTORB" },
  { "OPP_SCIENTIST", 7, 2, "GULPIN" },
  { "OPP_SCIENTIST", 7, 3, "MAGNETON" },
  { "OPP_SCIENTIST", 7, 4, "ELECTRIKE" },
  { "OPP_SCIENTIST", 7, 5, "KOFFING" },
  { "OPP_SCIENTIST", 8, 1, "ELECTRIKE" },
  { "OPP_SCIENTIST", 8, 2, "SWALOT" },
  { "OPP_SCIENTIST", 9, 1, "GULPIN" },
  { "OPP_SCIENTIST", 9, 2, "ELECTRODE" },
  { "OPP_SCIENTIST", 10, 1, "VOLTORB" },
  { "OPP_SCIENTIST", 10, 2, "GULPIN" },
  { "OPP_SCIENTIST", 10, 3, "MAGNETON" },
  { "OPP_SCIENTIST", 11, 1, "ELECTRIKE" },
  { "OPP_SCIENTIST", 11, 2, "KOFFING" },

  -- Silph 5F Juggler (psychic showcase)
  { "OPP_JUGGLER", 1, 1, "KIRLIA" },
  { "OPP_JUGGLER", 1, 2, "MR_MIME" },

  -- Pokemon Mansion: fire Gen 2–3 burglars + electric scientists
  { "OPP_BURGLAR", 7, 1, "CYNDAQUIL" },
  { "OPP_BURGLAR", 7, 2, "QUILAVA" },
  { "OPP_BURGLAR", 8, 1, "HOUNDOOM" },
  { "OPP_BURGLAR", 9, 1, "HOUNDOUR" },
  { "OPP_BURGLAR", 9, 2, "NUMEL" },
  { "OPP_SCIENTIST", 12, 1, "ELECTRIKE" },
  { "OPP_SCIENTIST", 12, 2, "MAGNETON" },
  { "OPP_SCIENTIST", 12, 3, "VOLTORB" },
  { "OPP_SCIENTIST", 13, 1, "ELECTRIKE" },
  { "OPP_SCIENTIST", 13, 2, "ELECTRODE" },

  -- Victory Road: late-game Cooltrainer / Blackbelt / Juggler / Tamer spice
  { "OPP_COOLTRAINER_F", 5, 1, "DELCATTY" },
  { "OPP_COOLTRAINER_F", 5, 2, "NINETALES" },
  { "OPP_BLACKBELT", 9, 1, "HARIYAMA" },
  { "OPP_BLACKBELT", 9, 2, "MAKUHITA" },
  { "OPP_BLACKBELT", 9, 3, "HARIYAMA" },
  { "OPP_JUGGLER", 2, 1, "SPOINK" },
  { "OPP_JUGGLER", 2, 2, "HYPNO" },
  { "OPP_JUGGLER", 2, 3, "KIRLIA" },
  { "OPP_JUGGLER", 2, 4, "KADABRA" },
  { "OPP_TAMER", 5, 1, "DONPHAN" },
  { "OPP_TAMER", 5, 2, "GOLDUCK" },
  { "OPP_POKEMANIAC", 6, 1, "QUILAVA" },
  { "OPP_POKEMANIAC", 6, 2, "LAPRAS" },
  { "OPP_POKEMANIAC", 6, 3, "LICKITUNG" },
  { "OPP_JUGGLER", 5, 1, "GARDEVOIR" },
  { "OPP_COOLTRAINER_M", 2, 1, "EXEGGUTOR" },
  { "OPP_COOLTRAINER_M", 2, 2, "WALREIN" },
  { "OPP_COOLTRAINER_M", 2, 3, "ARCANINE" },
  { "OPP_COOLTRAINER_F", 2, 1, "ROSELIA" },
  { "OPP_COOLTRAINER_F", 2, 2, "BRELOOM" },
  { "OPP_COOLTRAINER_F", 2, 3, "VICTREEBEL" },
  { "OPP_COOLTRAINER_M", 3, 1, "CRAWDAUNT" },
  { "OPP_COOLTRAINER_M", 3, 2, "TENTACRUEL" },
  { "OPP_COOLTRAINER_M", 3, 3, "BLASTOISE" },
  { "OPP_COOLTRAINER_F", 3, 1, "PARASECT" },
  { "OPP_COOLTRAINER_F", 3, 2, "PILOSWINE" },
  { "OPP_COOLTRAINER_F", 3, 3, "BLISSEY" },
  ...
  -- Route 23 / Victory Road Cooltrainer M #9: swap Dugtrio to Flygon
...
local ACE_BERRIES = {
  ...
  { "OPP_GIOVANNI", 1, "BERRY" },
  { "OPP_GIOVANNI", 2, "RAWST_BERRY" },
