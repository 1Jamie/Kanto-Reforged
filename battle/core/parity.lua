...
function Parity.allEffectIds()
  ...
  local shared = {
    ...
    "EXP_HEAL_BELL_EFFECT", "EXP_HEAL_BLOCK_EFFECT", "EXP_HELPING_HAND_EFFECT",
    "EXP_IMPRISON_EFFECT",
    ...
    "EXP_STOCKPILE_EFFECT", "EXP_SUCKER_PUNCH_EFFECT", "EXP_SWAGGER_EFFECT",
    "EXP_SWALLOW_EFFECT",
    ...
    "EXP_METAL_BURST_EFFECT", "EXP_FINAL_GAMBIT_EFFECT",
    "EXP_LAST_RESORT_EFFECT", "EXP_BELCH_EFFECT", "EXP_NATURAL_GIFT_EFFECT",
    "EXP_FLING_EFFECT",
  }
