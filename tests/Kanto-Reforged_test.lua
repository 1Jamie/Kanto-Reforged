...
require("mods.Kanto-Reforged.tests.gen3_tms_test")(T, Data, run)
...
require("mods.Kanto-Reforged.tests.empty_moves_repair_test")(T, Data, run)
...
require("mods.Kanto-Reforged.tests.pc_boxes_test")(T, Data, run)
...
require("mods.Kanto-Reforged.tests.ability_entry_timing_test")(T, Data)
...
require("mods.Kanto-Reforged.tests.version_exclusives_test")(T)
